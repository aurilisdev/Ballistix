...
public abstract class VirtualProjectile {
    ...
    public static class VirtualSAM extends VirtualProjectile {
        ...
        public AxisAlignedBB getBoundingBox() {
        	return variant == 0 ?
            //
                    new AxisAlignedBB(position.x - 0.25 * speed, position.y, position.z - 0.25F * speed, position.x + 0.25F * speed, position.y + 1F * speed, position.z + 0.25F * speed) :
                    //
                    new AxisAlignedBB(position.x - 0.25F * speed, position.y, position.z - 0.25F * speed, position.x + 0.25F * speed, position.y + 2.0F * speed, position.z + 0.25F * speed);
        }
        ...
        public void updatePosition(ServerWorld level) {
            ...
            Vector3d desiredVector = new Vector3d(deltaX, deltaY, deltaZ).normalize();
