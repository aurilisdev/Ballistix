...
public interface ILauncherControlPanel {
    ...
    /**
     * All designators i.e. the Laser Designator and the Radar gun will call this
     * method variant instead of the standard launch() method. This is to allow you
     * to tweak the coordinates before doing something
     * 
     * @param target
     */
