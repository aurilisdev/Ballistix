...
public class ChapterBlocks extends Chapter {
	...
	protected List<Page> genPages() {
		...
		pages.add(new Page(new TextWrapperObject[] {
				...
				//
				new TextWrapperObject(93, 140, 4210752, "guidebook.ballistix.chapter.blocks.silorange", 3000, new TranslatableComponent("guidebook.ballistix.chapter.blocks.missileblocks")),
				//
				new TextWrapperObject(10, 140, 4210752, "guidebook.ballistix.chapter.blocks.p1l7"),
				//
				new TextWrapperObject(93, 150, 4210752, "guidebook.ballistix.chapter.blocks.silorange", 10000, new TranslatableComponent("guidebook.ballistix.chapter.blocks.missileblocks")),
				//
				new TextWrapperObject(10, 150, 4210752, "guidebook.ballistix.chapter.blocks.p1l8"),
				//
				new TextWrapperObject(93, 160, 4210752, "guidebook.ballistix.chapter.blocks.silorange", new TranslatableComponent("guidebook.ballistix.chapter.blocks.missileunlimited"), ""),
				//
