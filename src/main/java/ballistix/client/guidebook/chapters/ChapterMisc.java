...
public class ChapterMisc extends Chapter {
    ...
    public void addData() {
        ...
        pageData.add(new TextWrapperObject(BallistixItems.ITEMS_MISSILE.getValue(SubtypeMissile.cluster).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered());
        ...
        pageData.add(new TextWrapperObject(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.airraidsiren).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
        ...
        pageData.add(new TextWrapperObject(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.proximitydetector).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
