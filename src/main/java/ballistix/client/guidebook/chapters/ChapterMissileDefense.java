...
public class ChapterMissileDefense extends Chapter {
    ...
    public void addData() {
        ...
        // Search Radar
        pageData.add(new TextWrapperObject(BallistixBlocks.blockRadar.asItem().getDescription().copy().withStyle(ChatFormatting.BOLD)).setCentered().setNewPage());
        ...
        // Fire Control Radar
        pageData.add(new TextWrapperObject(BallistixBlocks.blockFireControlRadar.asItem().getDescription().copy().withStyle(ChatFormatting.BOLD)).setCentered().setNewPage());
        ...
        // ESM Tower
        pageData.add(new TextWrapperObject(BallistixBlocks.blockEsmTower.asItem().getDescription().copy().withStyle(ChatFormatting.BOLD)).setCentered().setNewPage());
        ...
        // SAM Turret
        pageData.add(new TextWrapperObject(BallistixBlocks.blockSamTurret.asItem().getDescription().copy().withStyle(ChatFormatting.BOLD)).setCentered().setNewPage());
        ...
        // CIWS Turret
        pageData.add(new TextWrapperObject(BallistixBlocks.blockCiwsTurret.asItem().getDescription().copy().withStyle(ChatFormatting.BOLD)).setCentered().setNewPage());
        ...
        // Laser Turret
        pageData.add(new TextWrapperObject(BallistixBlocks.blockLaserTurret.asItem().getDescription().copy().withStyle(ChatFormatting.BOLD)).setCentered().setNewPage());
        ...
        // Railgun Turret
        pageData.add(new TextWrapperObject(BallistixBlocks.blockRailgunTurret.asItem().getDescription().copy().withStyle(ChatFormatting.BOLD)).setCentered().setNewPage());
