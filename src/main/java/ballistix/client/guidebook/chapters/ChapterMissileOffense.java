...
public class ChapterMissileOffense extends Chapter {
    ...
    public void addData() {
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missileoffense.controlpanel").withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missileoffense.l3",
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launchercontrolpaneltier1).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launchercontrolpaneltier2).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launchercontrolpaneltier3).getDescription().copy().withStyle(TextFormatting.BOLD)
                //
        )).setIndentions(1).setSeparateStart());
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missileoffense.launchplatform").withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missileoffense.l4",
                ...
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launcherplatformtier1).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                BallistixConstants.LAUNCHER_PLATFORM_RANGE_T1,
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launcherplatformtier2).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                BallistixConstants.LAUNCHER_PLATFORM_RANGE_T2,
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launcherplatformtier3).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missileoffense.supportframe").withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missileoffense.l6",
                ...
                //
                new StringTextComponent(BallistixConstants.LAUNCH_PLATFORM_DEFAULT_INACCURACY + "").withStyle(TextFormatting.BOLD),
                //
                new StringTextComponent(BallistixConstants.LAUNCH_PLATFORM_DEFAULT_INACCURACY + ""),
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launchersupportframetier1).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                new StringTextComponent("" + 30).withStyle(TextFormatting.BOLD),
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launchersupportframetier2).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                new StringTextComponent("" + 15).withStyle(TextFormatting.BOLD),
                //
                BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launchersupportframetier3).getDescription().copy().withStyle(TextFormatting.BOLD),
                //
                new StringTextComponent("" + 0).withStyle(TextFormatting.BOLD)
                //
        )).setIndentions(1).setSeparateStart());
