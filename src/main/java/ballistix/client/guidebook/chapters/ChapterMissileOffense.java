...
public class ChapterMissileOffense extends Chapter {
    ...
    public void addData() {
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missileoffense.l6",
                ...
                //
                new TextComponent(BallistixConstants.LAUNCH_PLATFORM_DEFAULT_INACCURACY + "").withStyle(ChatFormatting.BOLD),
                //
                new TextComponent(BallistixConstants.LAUNCH_PLATFORM_DEFAULT_INACCURACY + ""),
                //
                ...
                //
                new TextComponent("" + 30).withStyle(ChatFormatting.BOLD),
                //
                ...
                //
                new TextComponent("" + 15).withStyle(ChatFormatting.BOLD),
                //
                ...
                //
                new TextComponent("" + 0).withStyle(ChatFormatting.BOLD)
                //
        )).setIndentions(1).setSeparateStart());
        ...
        pageData.add(new TextWrapperObject(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.vls).getDescription().copy().withStyle(ChatFormatting.BOLD)).setCentered().setNewPage());
