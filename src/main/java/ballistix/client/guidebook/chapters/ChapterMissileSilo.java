...
public class ChapterMissileSilo extends Chapter {
    ...
    public void addData() {
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missilesilo.l2", BallistixTextUtils.guidebook("chapter.missilesilo.controlpanel").withStyle(TextFormatting.BOLD))).setIndentions(1).setSeparateStart());
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missilesilo.l3.1",
                //
                BallistixTextUtils.guidebook("chapter.missilesilo.launchplatform").withStyle(TextFormatting.BOLD),
                //
        ...
        pageData.add(new TextWrapperObject(BallistixTextUtils.guidebook("chapter.missilesilo.l4", BallistixTextUtils.guidebook("chapter.missilesilo.supportframe").withStyle(TextFormatting.BOLD), BallistixConstants.LAUNCH_PLATFORM_DEFAULT_INACCURACY)).setIndentions(1).setSeparateStart());
