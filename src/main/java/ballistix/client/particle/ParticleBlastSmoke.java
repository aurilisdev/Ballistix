...
public class ParticleBlastSmoke extends SpriteTexturedParticle {
	...
	public static double smoothStep(double u) {
		...
		if (u > 1)
			u = 1;
		return Math.pow((1 - MathHelper.cos((float) (Math.PI * u))) / 2.0, 5.0);
	}
	...
	public ParticleBlastSmoke(ClientWorld level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, ParticleOptionsBlastSmoke options, IAnimatedSprite set) {
	...
	public static class Factory implements IParticleFactory<ParticleOptionsBlastSmoke>, IParticleMetaFactory<ParticleOptionsBlastSmoke> {
		...
		@Override
		public Particle createParticle(ParticleOptionsBlastSmoke type, ClientWorld level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new ParticleBlastSmoke(level, x, y, z, xSpeed, ySpeed, zSpeed, type, sprites);
		}

		@Override
		public IParticleFactory<ParticleOptionsBlastSmoke> create(IAnimatedSprite sprites) {
