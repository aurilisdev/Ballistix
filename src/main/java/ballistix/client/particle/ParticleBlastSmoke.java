...
public class ParticleBlastSmoke extends TextureSheetParticle {
    ...
    public ParticleBlastSmoke(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed,
	    double zSpeed, ParticleOptionBlastSmoke options, SpriteSet set) {
    ...
    public static class Factory implements ParticleProvider<ParticleOptionBlastSmoke>,
	    ParticleEngine.SpriteParticleRegistration<ParticleOptionBlastSmoke> {
	...
	@Override
	public Particle createParticle(ParticleOptionBlastSmoke type, ClientLevel level, double x, double y, double z,
		double xSpeed, double ySpeed, double zSpeed) {
	    return new ParticleBlastSmoke(level, x, y, z, xSpeed, ySpeed, zSpeed, type, sprites);
	}

	@Override
	public ParticleProvider<ParticleOptionBlastSmoke> create(SpriteSet sprites) {
