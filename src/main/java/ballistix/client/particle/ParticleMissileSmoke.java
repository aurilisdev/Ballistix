...
public class ParticleMissileSmoke extends TextureSheetParticle {
	...
	if (lifeProgress <= 1 && lifeProgress >= 0) {
	    ...
	    this.rCol = ParticleBlastSmoke.smoothTransition(age + partialTicks, startRed, endRed, endGray, orangeTime,
		    burningTime - orangeTime);
	    this.gCol = ParticleBlastSmoke.smoothTransition(age + partialTicks, startGreen, endGreen, endGray,
		    orangeTime, burningTime - orangeTime);
	    this.bCol = ParticleBlastSmoke.smoothTransition(age + partialTicks, startBlue, endBlue, endGray, orangeTime,
		    burningTime - orangeTime);
