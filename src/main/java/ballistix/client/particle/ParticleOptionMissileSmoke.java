...
public class ParticleOptionMissileSmoke extends ParticleType<ParticleOptionMissileSmoke> implements ParticleOptions {

    public static final MapCodec<ParticleOptionMissileSmoke> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
	    ...
	    .apply(instance, (r, g, b, scale, lifetime, physics) -> new ParticleOptionMissileSmoke().setParameters(r, g,
		    b, scale, lifetime, physics)));
    public static final StreamCodec<RegistryFriendlyByteBuf, ParticleOptionMissileSmoke> STREAM_CODEC = StreamCodec
	    .composite(ByteBufCodecs.FLOAT, instance0 -> instance0.r, ByteBufCodecs.FLOAT, instance0 -> instance0.g,
		    ...
		    (r, g, b, scale, lifetime, physics) -> new ParticleOptionMissileSmoke().setParameters(r, g, b,
    ...
    public ParticleOptionMissileSmoke() {
	super(false);
    }

    public ParticleOptionMissileSmoke setParameters(float r, float g, float b, float scale, int lifetime,
	    boolean physics) {
	this.r = r;
	this.g = g;
	this.b = b;
    ...
    @Override
    public MapCodec<ParticleOptionMissileSmoke> codec() {
	return CODEC;
    }

    @Override
    public StreamCodec<? super RegistryFriendlyByteBuf, ParticleOptionMissileSmoke> streamCodec() {
	return STREAM_CODEC;
    }
}
