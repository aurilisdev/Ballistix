...
public class ParticleOptionsBlastSmoke extends ParticleType<ParticleOptionsBlastSmoke> implements ParticleOptions {
    ...
    public static final Codec<ParticleOptionsBlastSmoke> CODEC = RecordCodecBuilder.create(instance -> instance.group(
	    ...
	    .apply(instance,
		    (r, g, b, scale, gravity, lifetime, physics, burning, burningTime,
			    friction) -> new ParticleOptionsBlastSmoke().setParameters(r, g, b, scale, gravity,
				    lifetime, physics, burning, burningTime, friction)));

    public static final ParticleOptions.Deserializer<ParticleOptionsBlastSmoke> DESERIALIZER = new ParticleOptions.Deserializer<>() {

	@Override
	public ParticleOptionsBlastSmoke fromCommand(ParticleType<ParticleOptionsBlastSmoke> type, StringReader reader)
	...
	@Override
	public ParticleOptionsBlastSmoke fromNetwork(ParticleType<ParticleOptionsBlastSmoke> type,
		FriendlyByteBuf buffer) {
	    return new ParticleOptionsBlastSmoke().setParameters(buffer.readFloat(), buffer.readFloat(),
		    buffer.readFloat(), buffer.readFloat(), buffer.readFloat(), buffer.readInt(), buffer.readBoolean(),
		    buffer.readBoolean(), buffer.readInt(), buffer.readDouble());
	}
    };
    public float r;
    public float g;
	...
	return ForgeRegistries.PARTICLE_TYPES.getKey(getType()).toString() + ", r: " + r + ", g: " + g + ", b: " + b
		+ ", scale: " + scale + ", gravity: " + gravity + ", lifetime: " + lifetime + ", physics: " + hasPhysics
		+ ", burning: " + burning + ", burningTime: " + burningTime + ", friction: " + friction;
    }
}
