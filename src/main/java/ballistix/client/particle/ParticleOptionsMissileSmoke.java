...
public class ParticleOptionsMissileSmoke extends ParticleType<ParticleOptionsMissileSmoke> implements IParticleData {
	...
	public static final IParticleData.IDeserializer<ParticleOptionsMissileSmoke> DESERIALIZER = new IParticleData.IDeserializer<ParticleOptionsMissileSmoke>() {
		...
		@Override
		public ParticleOptionsMissileSmoke fromNetwork(ParticleType<ParticleOptionsMissileSmoke> type, PacketBuffer buffer) {
