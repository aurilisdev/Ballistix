...
public class ParticleOptionsMissileSmoke extends ParticleType<ParticleOptionsMissileSmoke> implements ParticleOptions {
	...
	@Override
	public ParticleOptionsMissileSmoke fromCommand(ParticleType<ParticleOptionsMissileSmoke> type,
	...
	@Override
	public ParticleOptionsMissileSmoke fromNetwork(ParticleType<ParticleOptionsMissileSmoke> type,
		FriendlyByteBuf buffer) {
	    return new ParticleOptionsMissileSmoke().setParameters(buffer.readFloat(), buffer.readFloat(),
		    buffer.readFloat(), buffer.readFloat(), buffer.readInt(), buffer.readBoolean());
	}
    };
	...
	return ForgeRegistries.PARTICLE_TYPES.getKey(getType()).toString() + ", r: " + r + ", g: " + g + ", b: " + b
		+ ", scale: " + scale + ", lifetime: " + lifetime + ", physics: " + hasPhysics;
    }
}
