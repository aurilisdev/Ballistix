...
public class ParticleOptionsShockwave extends ParticleType<ParticleOptionsShockwave> implements ParticleOptions {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ParticleOptionsShockwave> STREAM_CODEC = CodecUtils
	    .composite(ByteBufCodecs.FLOAT, instance0 -> instance0.r, ByteBufCodecs.FLOAT, instance0 -> instance0.g,
		    ByteBufCodecs.FLOAT, instance0 -> instance0.b, ByteBufCodecs.FLOAT, instance0 -> instance0.a,
		    ByteBufCodecs.FLOAT, instance0 -> instance0.scale, ByteBufCodecs.INT,
		    instance0 -> instance0.lifetime, ByteBufCodecs.BOOL, instance0 -> instance0.hasPhysics,
		    ByteBufCodecs.DOUBLE, instance0 -> instance0.friction,
		    (r, g, b, a, scale, lifetime, physics, friction) -> new ParticleOptionsShockwave().setParameters(r,
			    g, b, a, scale, lifetime, physics, friction));
