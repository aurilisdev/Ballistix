...
public class ParticleOptionsShockwave extends ParticleType<ParticleOptionsShockwave> implements IParticleData {
	...
	public static final Codec<ParticleOptionsShockwave> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			//
			.apply(instance, (r, g, b, a, scale, lifetime, physics, friction) -> new ParticleOptionsShockwave().setParameters(r, g, b, a, scale, lifetime, physics, friction)));

	public static final IParticleData.IDeserializer<ParticleOptionsShockwave> DESERIALIZER = new IParticleData.IDeserializer<ParticleOptionsShockwave>() {
		...
		@Override
		public ParticleOptionsShockwave fromNetwork(ParticleType<ParticleOptionsShockwave> type, PacketBuffer buffer) {
	...
	public String writeToString() {
		return ForgeRegistries.PARTICLE_TYPES.getKey(getType()).toString() + ", r: " + r + ", g: " + g + ", b: " + b + ", a: " + a + ", scale: " + scale + ", lifetime: " + lifetime +  ", physics: " + hasPhysics + ", friction: " + friction;
	}
}
