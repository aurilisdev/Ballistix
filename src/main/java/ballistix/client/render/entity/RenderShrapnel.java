...
//	GlStateManager._rotatef(entity.yRotO + (entity.yRot - entity.yRotO) * partialTicks - 90.0F, 0.0F, 1.0F, 0.0F);
//	GlStateManager._rotatef(entity.xRotO + (entity.xRot - entity.xRotO) * partialTicks, 0.0F, 0.0F, 1.0F);
