...
public class RenderLaserTurret extends AbstractTileRenderer<TileTurretLaser> {
    ...
    @Override
    public void render(@NotNull TileTurretLaser tileEntityIn, float partialTicks, PoseStack matrixStackIn,
	...
	RenderingUtils.renderFilledBoxNoOverlay(matrixStackIn, bufferIn.getBuffer(RenderType.SOLID), box, 1.0F, 0, 0,
		1.0F, sprite.getU0(), sprite.getV0(), sprite.getU1(), sprite.getV1(), combinedLightIn,
