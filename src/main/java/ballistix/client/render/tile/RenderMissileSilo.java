...
public class RenderMissileSilo extends TileEntityRenderer<TileMissileSilo> {
    ...
    @Override
    @Deprecated
    public void render(TileMissileSilo tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn,
	...
	if (type == 1) {
	    ...
	    Minecraft.getInstance().getBlockRendererDispatcher().getBlockModelRenderer().renderModel(tileEntityIn.getWorld(), closerange,
