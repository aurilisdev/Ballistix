...
public class ScreenAirRaidSiren extends GenericScreen<ContainerAirRaidSiren> {
    ...
    public ScreenAirRaidSiren(ContainerAirRaidSiren container, Inventory inv, Component title) {
        ...
        addComponent(new ScreenComponentSimpleLabel(19, 55, 10, Color.TEXT_GRAY, Component.literal("" + TileAirRaidSiren.MIN_VOLUME)));
        addComponent(new ScreenComponentSimpleLabel(144, 55, 10, Color.TEXT_GRAY, Component.literal("" + TileAirRaidSiren.MAX_VOLUME)));
        ...
        addComponent(new ScreenComponentSimpleLabel(19, 95, 10, Color.TEXT_GRAY, Component.literal("" + TileAirRaidSiren.MIN_PITCH)));
        addComponent(new ScreenComponentSimpleLabel(144, 95, 10, Color.TEXT_GRAY, Component.literal("" + TileAirRaidSiren.MAX_PITCH)));
        ...
        addComponent(new ScreenComponentSimpleLabel(19, 135, 10, Color.TEXT_GRAY, Component.literal("" + TileAirRaidSiren.MIN_RANGE)));
        addComponent(new ScreenComponentSimpleLabel(140, 135, 10, Color.TEXT_GRAY, Component.literal("" + TileAirRaidSiren.MAX_RANGE)));
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollX, double scrollY) {
        ...
        if (volumeSlider != null && siren != null && isPointInRegion(volumeSlider.xLocation, volumeSlider.yLocation, mouseX - getGuiWidth(), mouseY - getGuiHeight(), volumeSlider.width, volumeSlider.height)) {
            int moveRoom = volumeSlider.width - 15 -2;
            siren.volume.setValue(round(Math.clamp(siren.volume.getValue() + scroll, TileAirRaidSiren.MIN_VOLUME, TileAirRaidSiren.MAX_VOLUME), 1));
        ...
        if (pitchSlider != null && siren != null && isPointInRegion(pitchSlider.xLocation, pitchSlider.yLocation, mouseX - getGuiWidth(), mouseY - getGuiHeight(), pitchSlider.width, pitchSlider.height)) {
            ...
            siren.pitch.setValue(round(Math.clamp(siren.pitch.getValue() + scroll, TileAirRaidSiren.MIN_PITCH, TileAirRaidSiren.MAX_PITCH), 1));
        ...
        if (rangeSlider != null && siren != null && isPointInRegion(rangeSlider.xLocation, rangeSlider.yLocation, mouseX - getGuiWidth(), mouseY - getGuiHeight(), rangeSlider.width, rangeSlider.height)) {
            ...
            siren.range.setValue((int) round(Math.clamp(siren.range.getValue() + scroll, TileAirRaidSiren.MIN_RANGE, TileAirRaidSiren.MAX_RANGE), 1));
