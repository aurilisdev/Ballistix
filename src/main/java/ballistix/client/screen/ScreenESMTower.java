...
public class ScreenESMTower extends GenericScreen<ContainerESMTower> {
    ...
    public ScreenESMTower(ContainerESMTower container, PlayerInventory inv, ITextComponent title) {
        ...
        addComponent(new ScreenComponentGuiTab(ScreenComponentGuiTab.GuiInfoTabTextures.REGULAR, BallistixIconTypes.SONAR_PROFILE, () -> {
            ...
            info.add(BallistixTextUtils.tooltip("turret.maxrange", ChatFormatter.formatDecimals(Constants.ESM_TOWER_SEARCH_RADIUS, 1).withStyle(TextFormatting.GRAY)).withStyle(TextFormatting.DARK_GRAY).getVisualOrderText());
        ...
        addComponent(new ScreenComponentBallistixLabel(25, 18, 10, ScreenComponentCustomRender.TEXT_GRAY, () -> {
            ...
            return tower.active.get() ? tower.searchRadarDetected.get() ? BallistixTextUtils.gui("esmtower.searchradardetected").withStyle(TextFormatting.GREEN) : BallistixTextUtils.gui("esmtower.nosearchradars").withStyle(TextFormatting.RED) : BallistixTextUtils.gui("esmtower.nosearchradars").withStyle(TextFormatting.RED);
