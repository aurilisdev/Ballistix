...
public class ScreenESMTower extends GenericScreen<ContainerESMTower> {
	...
	addComponent(new ScreenComponentElectricInfo(-AbstractScreenComponentInfo.SIZE + 1, 2)
		.wattage(BallistixConstants.ESM_TOWER_USAGE_PER_TICK * 20));
		...
		ScreenComponentSlot.IconType.SONAR_PROFILE, () -> {
		    ...
		    info.add(BallistixTextUtils
			    .tooltip("turret.maxrange",
				    ChatFormatter.formatDecimals(BallistixConstants.ESM_TOWER_SEARCH_RADIUS, 1)
	...
	addComponent(slider = new ScreenComponentVerticalSlider(11, 40, 120)
		.setClickConsumer(wrapper.getSliderClickedConsumer())
		.setDragConsumer(wrapper.getSliderDraggedConsumer()));
