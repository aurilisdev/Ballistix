...
public class ScreenRailgunTurret extends ScreenPlayerWhitelistTurret<ContainerRailgunTurret> {
	...
	whitelistWrapper = new WrapperPlayerWhitelist(this, -AbstractScreenComponentInfo.SIZE + 1,
	...
	addComponent(new ScreenComponentElectricInfo(-AbstractScreenComponentInfo.SIZE + 1, 2)
		.wattage(Constants.RAILGUN_TURRET_USAGEPERTICK * 20));
		...
		BallistixIconTypes.TARGET_MISSILE, () -> {
		    ...
		    text.add(BallistixTextUtils
			    .tooltip("turret.maxrange",
				    ChatFormatter.formatDecimals(turret.currentRange.get(), 1)
	...
	addComponent(new ScreenComponentGuiTab(ScreenComponentGuiTab.GuiInfoTabTextures.REGULAR_RIGHT,
		BallistixIconTypes.TARGET_ENTITY, () -> {
		    ...
		    text.add(BallistixTextUtils
			    .tooltip("turret.maxrange",
				    ChatFormatter.formatDecimals(turret.currentRange.get() / 4.0, 1)
					    .withStyle(ChatFormatting.GRAY))
			    .withStyle(ChatFormatting.DARK_GRAY).getVisualOrderText());
		    text.add(
			    BallistixTextUtils
	...
	addComponent(radarLabel = new ScreenComponentCustomRender(10, 50, graphics -> {
	    ...
	    Component radar = turret.isNotLinked.get()
		    ? BallistixTextUtils.gui("turret.radarnone").withStyle(ChatFormatting.RED)
		    : Component.literal(turret.boundFireControl.get().toShortString())
	...
	addComponent(statusLabel = new ScreenComponentSimpleLabel(10, 65, 10, Color.WHITE, () -> {
		...
		if (turret.targetingEntity.get()) {
			...
			status = BallistixTextUtils.gui("turret.statuscooldown", turret.cooldown.get())
