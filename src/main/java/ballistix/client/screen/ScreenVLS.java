...
public class ScreenVLS extends GenericScreen<ContainerVLS> {
	...
	addComponent(new ScreenComponentSimpleLabel(101, 39, 10, Color.TEXT_GRAY,
	...
	list.add(BallistixTextUtils
		.tooltip("missilesilo.charge",
			...
			ChatFormatter.getChatDisplayShort(BallistixConstants.MISSILESILO_USAGE, DisplayUnits.JOULES)
				.withStyle(ChatFormatting.GRAY))
