...
public class CameraShakeManager {
	...
	public static void onClientTick(ClientTickEvent event) {
		...
		if (mc.player.isOnGround()) {
			mc.player.yRot = mc.player.yRot + totalYawOffset;
			mc.player.xRot = mc.player.xRot + totalPitchOffset;
		}
	}

	public static CameraShakeEffect createBlastSourcedEffect(double blastDuration, double blastSize, long worldTime, Vector3d position) {
