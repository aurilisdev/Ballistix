...
public class BlastAntimatter extends Blast implements IHasCustomRenderer {
	...
	public boolean doExplode(int callCount) {
		if (!world.isClientSide) {
			...
			Explosion ex = new Explosion(world, null, null, null, position.getX(), position.getY(), position.getZ(), (float) Constants.EXPLOSIVE_ANTIMATTER_RADIUS, false, BlockInteraction.DESTROY);
