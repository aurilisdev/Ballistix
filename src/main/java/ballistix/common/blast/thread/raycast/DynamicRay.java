...
public class DynamicRay {
    ...
    public boolean tick(final BlockPos position, final World world, final IResistanceCallback callback, final Entity explosionSource, HashMap<BlockPos, BlockState> alreadyDestroyed) {
        if (power > 0.0F) {
