...
public class BlastAntigravity extends Blast {
	...
	for (int i = -BallistixConfig.INSTANCE.EXPLOSIVE_ANTIGRAVITY_CHUNKRADIUS
		.get(); i < BallistixConfig.INSTANCE.EXPLOSIVE_ANTIGRAVITY_CHUNKRADIUS.get(); i++) {
	    for (int j = -BallistixConfig.INSTANCE.EXPLOSIVE_ANTIGRAVITY_CHUNKRADIUS
		    .get(); j < BallistixConfig.INSTANCE.EXPLOSIVE_ANTIGRAVITY_CHUNKRADIUS.get(); j++) {
		...
		set.add(new AntigravedChunk(chunkPos,
			BallistixConfig.INSTANCE.EXPLOSIVE_ANTIGRAVITY_CHUNKDURATION.get()));
