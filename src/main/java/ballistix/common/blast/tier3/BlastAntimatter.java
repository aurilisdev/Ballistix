...
public class BlastAntimatter extends BlastLasting implements IHasCustomRender {
	...
	public void produceParticles() {
		...
		ParticleUtilities.spawnParticleSphere(particle, x, y, z, 100, -90, 90, BallistixConfig.INSTANCE.EXPLOSIVE_ANTIMATTER_RADIUS.get() / BallistixConfig.INSTANCE.EXPLOSIVE_ANTIMATTER_DURATION.get() * 2, true);
		// Shockwave
		double spawnSize = 3;
