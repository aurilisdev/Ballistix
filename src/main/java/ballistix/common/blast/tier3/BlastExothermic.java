...
public class BlastExothermic extends BlastLasting implements IHasCustomRender {
    ...
    public boolean doExplode(int callCount) {
        ...
        if (pertick == -1) {
            ...
            world.explode(null, position.getX(), position.getY(), position.getZ(), (float) BallistixConstants.EXPLOSIVE_EXOTHERMIC_RADIUS * 0.85F, Level.ExplosionInteraction.BLOCK);
        }
