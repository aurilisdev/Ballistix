...
public class BlastHypersonic extends BlastLasting {
    ...
    public boolean doExplode(int callCount) {
        ...
        while (iterator.hasNext()) {
            ...
            if(state.isAir() || state.getDestroySpeed(world, p) < 0 || state.getDestroySpeed(world, p) > BallistixConstants.EXPLOSIVE_HYPERSONIC_MAXHARDNESS || state.getBlock() instanceof LiquidBlock) {
                continue;
            }
