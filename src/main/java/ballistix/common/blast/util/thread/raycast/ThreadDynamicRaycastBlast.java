...
public class ThreadDynamicRaycastBlast extends ThreadBlast {
	...
	public ThreadDynamicRaycastBlast(World world, BlockPos position, int range, float energy, Entity source, IResistanceCallback cb) {
		super(world, position, range, energy, source);
		callBack = cb;
		setName("RaycastBlast Main Thread");
	}

	public ThreadDynamicRaycastBlast(World world, BlockPos position, int range, float energy, Entity source) {
