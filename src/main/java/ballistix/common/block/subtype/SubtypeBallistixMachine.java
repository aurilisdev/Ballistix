...
public enum SubtypeBallistixMachine implements ISubtype, IMachine {
	...
	private SubtypeBallistixMachine(boolean showInItemGroup, TileEntitySupplier<TileEntity> blockEntitySupplier) {
		this(showInItemGroup, blockEntitySupplier, MachineProperties.DEFAULT);
	}

	private SubtypeBallistixMachine(boolean showInItemGroup, TileEntitySupplier<TileEntity> blockEntitySupplier, MachineProperties properties) {
	...
	public static class Subnodes {
		...
		public static IMultiblockParentBlock.SubnodeWrapper ESM_TOWER = make(() -> {
			...
			Subnode middle = new Subnode(new BlockPos(0, 1, 0), VoxelShapes.or(Block.box(6, 0, 6, 10, 13, 10), Block.box(5, 13, 5, 11, 16, 11)));
		...
		public static final IMultiblockParentBlock.SubnodeWrapper LAUNCHER_PLATFORM_TIER1 = make(() -> {
			...
			VoxelShape leftShape = VoxelShapes.join(Block.box(0, 1, 5, 2, 5, 11), Block.box(0, 0, 3, 4, 1, 13), IBooleanFunction.OR);
			VoxelShape rightShape = VoxelShapes.join(Block.box(12, 0, 3, 16, 1, 13), Block.box(14, 1, 5, 16, 5, 11), IBooleanFunction.OR);
			subnodesNorth[0] = new Subnode(new BlockPos(0, 1, 0), topShape);
		...
		public static final IMultiblockParentBlock.SubnodeWrapper LAUNCHER_PLATFORM_TIER2 = make(() -> {
			...
			VoxelShape leftShape = VoxelShapes.join(Block.box(0, 0, 3, 4, 1, 13), Block.box(0, 1, 5, 3, 5, 11), IBooleanFunction.OR);
			VoxelShape rightShape = VoxelShapes.join(Block.box(12, 0, 3, 16, 1, 13), Block.box(13, 1, 5, 16, 5, 11), IBooleanFunction.OR);
			subnodesNorth[0] = new Subnode(new BlockPos(0, 1, 0), topShape);
			subnodesNorth[1] = new Subnode(new BlockPos(1, 0, 0), leftShape);
			subnodesNorth[2] = new Subnode(new BlockPos(-1, 0, 0), rightShape);
		...
		public static final IMultiblockParentBlock.SubnodeWrapper LAUNCHER_PLATFORM_TIER3 = make(() -> {
			...
			VoxelShape topLeftShape = Stream.of(Block.box(2, 0, 6, 3, 7, 10), Block.box(1, 0, 7, 2, 7, 9), Block.box(0, 0.025, 7, 1, 1.975, 9), Block.box(2, 7, 7, 3, 16, 9)).reduce((v1, v2) -> VoxelShapes.join(v1, v2, IBooleanFunction.OR)).get();
		...
		public static final IMultiblockParentBlock.SubnodeWrapper VLS = make(() -> IMultiblockParentBlock.SubnodeWrapper.createOmni(new Subnode[]{new Subnode(new BlockPos(0, 1, 0), VoxelShapes.block())}));
