...
public class ContainerLauncherPlatformT2 extends GenericContainerBlockEntity<TileLauncherPlatformT2> {
	...
	public ContainerLauncherPlatformT2(int id, PlayerInventory playerinv) {
		this(id, playerinv, new Inventory(2), new IntArray(5));
	}

	public ContainerLauncherPlatformT2(int id, PlayerInventory playerinv, IInventory inventory, IIntArray inventorydata) {
