...
public class ContainerMissileSilo extends GenericContainerInventory {
	...
	public void addInventorySlots(IInventory inv, PlayerInventory playerinv) {
		addSlot(new SlotRestricted(inv, nextIndex(), 103, 14, DeferredRegisters.ITEM_MISSILECLOSERANGE.get(), DeferredRegisters.ITEM_MISSILEMEDIUMRANGE.get(), DeferredRegisters.ITEM_MISSILELONGRANGE.get()));
	...
	public void setCoord(String valX, String valY, String valZ) {
		...
		NetworkHandler.CHANNEL.sendToServer(new PacketSetMissileData(new BlockPos(getXCoord(), getYCoord(), getZCoord()), new BlockPos(triedX, triedY, triedZ)));
	}
}
