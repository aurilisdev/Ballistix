...
public class BallistixConfig {
    ...
    public BallistixConfig() {
        ...
        EXPLOSIVE_ATTRACTIVE_REPULSIVE_PUSH_STRENGTH = builder.defineInRange("explosive_attractive_repulsive_push_strength", 2.0, 0, Double.MAX_VALUE);
        ...
        EXPLOSIVE_SHRAPNEL_SHRAPNEL_COUNT = builder.defineInRange("explosive_shrapnel_shrapnel_count", 25.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_CHEMICAL_SIZE = builder.defineInRange("explosive_chemical_size", 7.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_CHEMICAL_DURATION = builder.comment("Value is in ticks.").defineInRange("explosive_chemical_duration_ticks", 1200.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_ANVIL_ANVILSPERBLAST = builder.defineInRange("explosive_anvil_anvilsperblast", 10, 0, Integer.MAX_VALUE);
        EXPLOSIVE_INFESTIVE_RADIUS = builder.defineInRange("explosive_infestive_radius", 7.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_INFESTIVE_DURATION = builder.comment("Value is in ticks.").defineInRange("explosive_infestive_duration_ticks", 20.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_DEBILITATION_SIZE = builder.defineInRange("explosive_debilitation_size", 7.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_DEBILITATION_DURATION = builder.comment("Value is in ticks.").defineInRange("explosive_debilitation_duration_ticks", 1200.0, 0, Double.MAX_VALUE);
        builder.pop(); // end tier1

        // Tier 2
        builder.push("tier2");
        EXPLOSIVE_FRAGMENTATION_SHRAPNEL_COUNT = builder.defineInRange("explosive_fragmentation_shrapnel_count", 50.0, 0, Double.MAX_VALUE);
        ...
        EXPLOSIVE_CONTAGIOUS_DURATION = builder.comment("Value is in ticks.").defineInRange("explosive_contagious_duration_ticks", 1200.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_BREACHING_SIZE = builder.defineInRange("explosive_breaching_size", 5.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_BREACHING_DURATION = builder.comment("Value is in ticks.").defineInRange("explosive_breaching_duration_ticks", 1.0, 0, Double.MAX_VALUE);
        ...
        // Tier 3
        builder.push("tier3");
        EXPLOSIVE_ANTIGRAVITY_CHUNKRADIUS = builder.defineInRange("explosive_antigravity_chunkradius", 3, 0, Integer.MAX_VALUE);
        EXPLOSIVE_ANTIGRAVITY_CHUNKDURATION = builder.comment("Value is in ticks.").defineInRange("explosive_antigravity_chunkduration_ticks", 12000, 0, Integer.MAX_VALUE);
        EXPLOSIVE_ANTIGRAVITY_GRAVITYFACTOR = builder.defineInRange("explosive_antigravity_gravityfactor", 1.1, 0, Double.MAX_VALUE);
        EXPLOSIVE_ANTIGRAVITY_MAXHEIGHT = builder.defineInRange("explosive_antigravity_maxheight", 300, 0, Integer.MAX_VALUE);
        EXPLOSIVE_ANTIGRAVITY_MAXBLOCKCHECKS = builder.comment("It is recommended to keep this value low").defineInRange("explosive_antigravity_maxblockchecks", 1, 0, Integer.MAX_VALUE);
        ...
        EXPLOSIVE_EXOTHERMIC_CHANCE_FOR_LAVA = builder.defineInRange("explosive_exothermic_chance_for_lava", 0.01, 0, 1);
        EXPLOSIVE_EXOTHERMIC_CHANCE_TO_BURN = builder.defineInRange("explosive_exothermic_chance_to_burn", 0.3, 0, 1);
        EXPLOSIVE_EXOTHERMIC_DURATION = builder.comment("Value is in ticks.").defineInRange("explosive_exothermic_duration_ticks", 20.0, 0, Double.MAX_VALUE);
        ...
        EXPLOSIVE_LARGEANTIMATTER_DURATION = builder.comment("Value is in ticks.").defineInRange("explosive_largeantimatter_duration_ticks", 200.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_DARKMATTER_RADIUS = builder.defineInRange("explosive_darkmatter_radius", 50.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_DARKMATTER_DURATION = builder.comment("Value is in ticks.").defineInRange("explosive_darkmatter_duration_ticks", 1200.0, 0, Double.MAX_VALUE);
        EXPLOSIVE_DARKMATTER_PERSISTANCE = builder.comment("How many iterations the blast will perform. Set to -1 for infinite, 0 for none.").defineInRange("explosive_darkmatter_persistance_iterations", 1200, Integer.MIN_VALUE, Integer.MAX_VALUE);
        EXPLOSIVE_DARKMATTER_MOVEMENTTICKS = builder.comment("Value is in ticks.").defineInRange("explosive_darkmatter_movementticks", 5, 0, Integer.MAX_VALUE);
        EXPLOSIVE_DARKMATTER_REPEATDURATION = builder.comment("Value is in ticks.").defineInRange("explosive_darkmatter_repeatduration_ticks", 1, 0, Integer.MAX_VALUE);
        builder.pop(); // end tier3
        builder.pop(); // end explosives

        // Missile silo
        builder.push("missile_silo");
        MISSILESILO_USAGE = builder.comment("Usage per launch in joules").defineInRange("missilesilo_usage_joules_per_launch", 10000.0, 0, Double.MAX_VALUE);
        ...
        LAUNCH_PLATFORM_DEFAULT_INACCURACY = builder.defineInRange("launch_platform_default_inaccuracy_deg", 45, 0, Integer.MAX_VALUE);
        builder.pop();
        ...
        RADAR_USAGE = builder.comment("Usage in watt for radar").defineInRange("radar_usage_watt", 10000.0, 0, Double.MAX_VALUE);
        RADAR_RANGE = builder.defineInRange("radar_range", 600, 0, Integer.MAX_VALUE);
        builder.pop();

        // Fire control radar
        builder.push("fire_control_radar");
        FIRE_CONTROL_RADAR_USAGE = builder.comment("Usage in watt for fire control radar").defineInRange("fire_control_radar_usage_watt", 10000.0, 0, Double.MAX_VALUE);
        FIRE_CONTROL_RADAR_RANGE = builder.defineInRange("fire_control_radar_range", 550, 0, Integer.MAX_VALUE);
        MAX_DISTANCE_FROM_RADAR = builder.comment("How far a turret can be from a fire control radar").defineInRange("max_distance_from_radar", 32.0, 0, Double.MAX_VALUE);
        builder.pop();
        ...
        SAM_TURRET_ROTATIONSPEEDRADIANS = builder.defineInRange("sam_turret_rotation_speed_radians", 0.2, 0, Double.MAX_VALUE);
        SAM_TURRET_COOLDOWN = builder.defineInRange("sam_turret_cooldown_ticks", 100, 0, Integer.MAX_VALUE);
        builder.pop();

        // SAM entity
        builder.push("sam_entity");
        SAM_ENTITY_TURNINGSPEEDRADIANS = builder.defineInRange("sam_entity_turning_speed_radians", 0.1, 0, Double.MAX_VALUE);
        ...
        ANTIBALLISTICMISSILE_ENTITY_TURNINGSPEEDRADIANS = builder.defineInRange("antiballisticmissile_entity_turning_speed_radians", 0.05, 0, Double.MAX_VALUE);
        ANTIBALLISTICMISSILE_CHANCE_TO_DESTROY = builder.defineInRange("antiballisticmissile_chance_to_destroy", 0.85, 0, 1);
        ANTIBALLISTICMISSILE_TOP_SPEED = builder.defineInRange("antiballisticmissile_top_speed", 5.0, 0, Double.MAX_VALUE);
        ANTIBALLISTICMISSILE_ACCELERATION = builder.defineInRange("antiballisticmissile_acceleration", 0.04, 0, Double.MAX_VALUE);
        ANTIBALLISTICMISSILE_MINTURNSPEED_PERC = builder.defineInRange("antiballisticmissile_minturnspeed_perc", 0.15, 0, 1);
        RANGE_INCREASE_INACCURACY_MULTIPLIER = builder.comment("The amount of inaccuracy each range upgrade will add to the turret. Affects shots past the base range. Set to 1 to disable.").defineInRange("range_increase_inaccuracy_multiplier", 1.001, 0, Double.MAX_VALUE);
        builder.pop();
        ...
        CIWS_TURRET_ROTATIONSPEEDRADIANS = builder.defineInRange("ciws_turret_rotation_speed_radians", 0.6, 0, Double.MAX_VALUE);
        ...
        LASER_TURRET_ROTATIONSPEEDRADIANS = builder.defineInRange("laser_turret_rotation_speed_radians", 0.2, 0, Double.MAX_VALUE);
        ...
        RAILGUN_TURRET_USAGEPERTICK = builder.defineInRange("railgun_turret_usage_per_tick", 10000.0, 0, Double.MAX_VALUE);
        RAILGUN_TURRET_BASE_RANGE = builder.defineInRange("railgun_turret_base_range", 300.0, 0, Double.MAX_VALUE);
        RAILGUN_TURRET_ROTATIONSPEEDRADIANS = builder.defineInRange("railgun_turret_rotation_speed_radians", 0.1, 0, Double.MAX_VALUE);
        ...
        PROXIMITYDETECTOR_USAGEPERTICK = builder.defineInRange("proximitydetector_usage_per_tick", 100.0, 0, Double.MAX_VALUE);
        builder.pop();

        // Items
        builder.push("items");
        ROCKET_LAUNCHER_COOLDOWN_TICKS = builder.defineInRange("rocket_launcher_cooldown_ticks", 60, 0, Integer.MAX_VALUE);
