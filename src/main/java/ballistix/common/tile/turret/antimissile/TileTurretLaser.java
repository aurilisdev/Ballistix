...
public class TileTurretLaser extends TileTurretAntimissile implements ITickableSound {
	...
	super(BallistixTiles.TILE_LASERTURRET.get(), worldPos, blockState, BallistixConstants.LASER_TURRET_BASE_RANGE,
		0, BallistixConstants.LASER_TURRET_USAGEPERTICK, BallistixConstants.LASER_TURRET_ROTATIONSPEEDRADIANS,
		0);
    }
