...
public class TileTurretSAM extends TileTurretAntimissileProjectile {
    ...
    public TileTurretSAM() {
        super(BallistixTiles.TILE_SAMTURRET.get(), BallistixConstants.SAM_TURRET_BASE_RANGE, 100, BallistixConstants.SAM_TURRET_USAGEPERTICK, BallistixConstants.SAM_TURRET_ROTATIONSPEEDRADIANS, 1);
    }
