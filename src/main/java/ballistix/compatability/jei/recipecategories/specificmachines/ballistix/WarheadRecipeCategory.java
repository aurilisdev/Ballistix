...
public class WarheadRecipeCategory extends ElectrodynamicsRecipeCategory<PsuedoDO2ORecipe> {
	...
	ingredients.setInputLists(VanillaTypes.ITEM, recipeInput());
	...
	fontRenderer.draw(matrixStack, missileString, GUI_BACKGROUND[2] - missileWidth - 46f, y - 37f, 0xFF333333);
	fontRenderer.draw(matrixStack, explosiveString, GUI_BACKGROUND[2] - explosiveWidth - 46f, y - 10f, 0xFF333333);
    }
    ...
    private static List<List<ItemStack>> recipeInput() {
