...
public class BallistixItemModelsProvider extends ElectrodynamicsItemModelsProvider {
	...
	protected void registerModels() {
		...
		simpleBlockItem(BallistixBlocks.blockEsmTower, existingBlock(blockLoc("esmtower"))).transforms().transform(ItemDisplayContext.GUI).scale(0.3F).rotation(30.0F, 225.0F, 0.0F).end();
