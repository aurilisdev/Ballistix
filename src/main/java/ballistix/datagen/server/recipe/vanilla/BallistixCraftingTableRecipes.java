...
public class BallistixCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launcherplatformtier1), 1)
		//
		.addPattern("S S")
		//
		.addPattern("SCS")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launcherplatformtier2), 1)
		//
		.addPattern("S S")
		//
		.addPattern("SCS")
		...
		//
		.addKey('P',
			BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launcherplatformtier1))
		//
		.addConditions(ELECTRO_LOADED)
		//
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launcherplatformtier3), 1)
		//
		.addPattern("S S")
		//
		.addPattern("SCS")
		...
		//
		.addKey('P',
			BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.launcherplatformtier2))
		//
		.addConditions(ELECTRO_LOADED)
		//
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE
			.getValue(SubtypeBallistixMachine.launchersupportframetier1), 1)
		//
		.addPattern("S S")
		//
		.addPattern("SSS")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE
			.getValue(SubtypeBallistixMachine.launchersupportframetier2), 1)
		//
		.addPattern("S S")
		//
		.addPattern("SVS")
		...
		//
		.addKey('V',
			BallistixItems.ITEMS_BALLISTIXMACHINE
				.getValue(SubtypeBallistixMachine.launchersupportframetier1))
		//
		.addConditions(ELECTRO_LOADED)
		//
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE
			.getValue(SubtypeBallistixMachine.launchersupportframetier3), 1)
		//
		.addPattern("S S")
		//
		.addPattern("SVS")
		...
		.addKey('V',
			BallistixItems.ITEMS_BALLISTIXMACHINE
				.getValue(SubtypeBallistixMachine.launchersupportframetier2))
		//
		.addConditions(ELECTRO_LOADED)
		//
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE
			.getValue(SubtypeBallistixMachine.launchercontrolpaneltier1), 1)
		//
		.addPattern("SGS")
		//
		.addPattern("SCS")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE
			.getValue(SubtypeBallistixMachine.launchercontrolpaneltier2), 1)
		//
		.addPattern("SWS")
		//
		.addPattern("SCS")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE
			.getValue(SubtypeBallistixMachine.launchercontrolpaneltier3), 1)
		//
		.addPattern("SWS")
		//
		.addPattern("SCS")
	...
	CustomShapedCraftingRecipe.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.vls), 1)
		...
		.addKey('C',
			BallistixItems.ITEMS_BALLISTIXMACHINE
				.getValue(SubtypeBallistixMachine.launchercontrolpaneltier1))
		//
		.addConditions(ELECTRO_LOADED)
		//
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.radar), 1)
		//
		.addPattern("WRW")
		//
		.addPattern(" M ")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.firecontrolradar), 1)
		//
		.addPattern(" G ")
		//
		.addPattern("CRC")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.esmtower), 1)
		//
		.addPattern("AAA")
		//
		.addPattern("WRW")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.samturret), 1)
		//
		.addPattern(" S ")
		//
		.addPattern("PMP")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.ciwsturret), 1)
		//
		.addPattern("PPC")
		//
		.addPattern(" M ")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.laserturret), 1)
		//
		.addPattern("GDG")
		//
		.addPattern(" M ")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.railgunturret), 1)
		//
		.addPattern("OOH")
		//
		.addPattern(" MT")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.airraidsiren), 1)
		//
		.addPattern("PPP")
		//
		.addPattern("MNM")
	...
	CustomShapedCraftingRecipe
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.proximitydetector), 1)
		//
		.addPattern("PPP")
		//
		.addPattern("COC")
	...
	battery.receivePower(fullBattery, TransferPack.joulesVoltage(battery.getElectricProperties().capacity,
		battery.getElectricProperties().receive.getVoltage()), false);
	 ...
	 * // .addPattern("PWP") // .addPattern("WBW") // .addPattern("PWP") //
