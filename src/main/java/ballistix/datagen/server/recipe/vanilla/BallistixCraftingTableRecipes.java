...
public class BallistixCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	ShapedCraftingRecipeBuilder
		.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.vls), 1)
		//
		.addPattern("SFS")
		//
		.addPattern("SLS")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_MISSILE.getValue(SubtypeMissile.cluster), 1)
		//
		.addPattern(" M ")
		//
		.addPattern("MBM")
	...
	ShapelessCraftingRecipeBuilder.start(BallistixItems.ITEM_DUSTPOISON.get(), 2)
		//
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.antigravity), 1)
		//
		.addPattern("EEE")
		//
		.addPattern("EAE")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.anvil), 10)
		//
		.addPattern("CCC")
		//
		.addPattern("CAC")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.emp), 1)
		...
		//
		.addKey('B',
			new ChargedItemIngredient(Ingredient.of(ElectrodynamicsItems.ITEM_BATTERY.get()),
				TransferPack.joulesVoltage(battery.getElectricProperties().capacity,
					battery.getElectricProperties().receive.getVoltage()),
				false))
		//
		.addKey('T', Items.TNT)
		//
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.ender), 1)
		//
		.addPattern("SPS")
		//
		.addPattern("SAS")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.endothermic), 1)
		//
		.addPattern("ISI")
		//
		.addPattern("SAS")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.exothermic), 1)
		//
		.addPattern("III")
		//
		.addPattern("IGI")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.infestive), 8)
		//
		.addPattern("SSS")
		//
		.addPattern("SCS")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.rejuvination), 1)
		//
		.addPattern("DDD")
		//
		.addPattern("DED")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.sonic), 2)
		//
		.addPattern("CNC")
		//
		.addPattern("NRN")
	...
	ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_EXPLOSIVE.getValue(SubtypeBlast.hypersonic), 1)
		//
		.addPattern(" S ")
		//
		.addPattern("SSS")
