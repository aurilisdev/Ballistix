...
public class BallistixCraftingTableRecipes extends AbstractRecipeGenerator {
    ...
    public void addRecipes(RecipeOutput output) {
        ...
        ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.vls), 1)
                //
                .addPattern("SFS")
                //
                .addPattern("SLS")
        ...
        ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.airraidsiren), 1)
                //
                .addPattern("PPP")
                //
                .addPattern("MNM")
        ...
        ShapedCraftingRecipeBuilder.start(BallistixItems.ITEMS_BALLISTIXMACHINE.getValue(SubtypeBallistixMachine.proximitydetector), 1)
                //
                .addPattern("PPP")
                //
                .addPattern("COC")
