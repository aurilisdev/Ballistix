...
public class ScreenComponentVerticalSlider extends ScreenComponentGeneric {
    ...
    public void renderBackground(PoseStack stack, int xAxis, int yAxis, int guiWidth, int guiHeight) {
        ...
        blit(stack, guiWidth + xLocation - 1, guiHeight + yLocation, width, 1, bg.textureU(), bg.textureV(), bg.textureWidth(), 1, bg.imageWidth(), bg.imageHeight());
        ...
        for (int i = 0; i < permutations; i++) {
        	...
        	RenderingUtils.bindTexture(bg.getLocation());
        	blit(stack, guiWidth + xLocation - 1, guiHeight + yLocation + 1 + i * 28, width, 28, bg.textureU(), bg.textureV() + 1, bg.textureWidth(), 28, bg.imageWidth(), bg.imageHeight());

        }

        RenderingUtils.bindTexture(bg.getLocation());
        blit(stack, guiWidth + xLocation - 1, guiHeight + yLocation + 1 + 28 * permutations, width, remainder, bg.textureU(), bg.textureV() + 1, bg.textureWidth(), remainder, bg.imageWidth(), bg.imageHeight());

        blit(stack, guiWidth + xLocation - 1, guiHeight + yLocation + height - 1, width, 1, bg.textureU(), bg.textureV() + 29, bg.textureWidth(), 1, bg.imageWidth(), bg.imageHeight());
        ...
        blit(stack, guiWidth + xLocation , guiHeight + yLocation + 1 + sliderYOffset, slider.textureWidth(), slider.textureHeight(), slider.textureU(), slider.textureV(), slider.textureWidth(), slider.textureHeight(), slider.imageWidth(), slider.imageHeight());
