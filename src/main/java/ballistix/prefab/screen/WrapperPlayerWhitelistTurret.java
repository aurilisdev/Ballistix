...
public class WrapperPlayerWhitelistTurret {
	...
	screen.addComponent(button = (ScreenComponentButton<?>) new ScreenComponentButton<>(
		ScreenComponentGuiTab.GuiInfoTabTextures.REGULAR, tabX, tabY).setOnPress(button -> {
		    ...
		    tooltips.add(
			    BallistixTextUtils.tooltip("turret.whitelistmanager").withStyle(ChatFormatting.DARK_GRAY));
		    if (!button.isPressed) {
	...
	screen.addComponent(whitelistLabel = new ScreenComponentSimpleLabel(x + 10, y + 23, 10, Color.TEXT_GRAY,
		BallistixTextUtils.gui("turret.playerwhitelist.newplayer")));
	...
	screen.addEditBox(addEditBox = new ScreenComponentEditBox(x + 10, y + 35, 156, 15, screen.getFontRenderer())
