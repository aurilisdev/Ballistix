...
public class BallistixEntities {
	...
	public static final RegistryObject<EntityType<EntityBlast>> ENTITY_BLAST = ENTITIES.register("blast", () -> EntityType.Builder.<EntityBlast>of(EntityBlast::new, EntityClassification.MISC).fireImmune().build(References.ID + ".blast"));
	...
	public static final RegistryObject<EntityType<EntityMissile>> ENTITY_MISSILE = ENTITIES.register("missile", () -> EntityType.Builder.<EntityMissile>of(EntityMissile::new, EntityClassification.MISC).fireImmune().sized(0, 0).build(References.ID + ".missile"));
}
