...
public class BallistixParticles {
	...
	public static final DeferredHolder<ParticleType<?>, ParticleOptionsBlastSmoke> PARTICLE_BLAST_SMOKE = PARTICLES
			.register("blastsmoke", ParticleOptionsBlastSmoke::new); 
	public static final DeferredHolder<ParticleType<?>, ParticleOptionsMissileSmoke> PARTICLE_MISSILE_SMOKE = PARTICLES
			.register("missilesmoke", ParticleOptionsMissileSmoke::new); 
	public static final DeferredHolder<ParticleType<?>, ParticleOptionsShockwave> PARTICLE_SHOCKWAVE = PARTICLES
			.register("shockwave", ParticleOptionsShockwave::new);
}
