...
public class BallistixSounds {
    ...
    public static final RegistryObject<SoundEvent> SOUND_LARGE_ANTIMATTEREXPLOSION = sound("largeantimatterexplosion",
	    "antimatterexplosion", 160);
	...
	return SOUNDS.register(name,
		() -> SoundEvent.createFixedRangeEvent(new ResourceLocation(Ballistix.ID + ":" + name), range));
    }
}
